...
* [<i class="fa-solid fa-asterisk" style="margin-right:8px;"></i>Getting Started](getting-started.md "Getting Started - First Accord")
* <i class="fa-solid fa-book-open-reader" style="margin-right:8px;"></i>Guide
